...
export default function ModernProductsSection() {
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4">
          {sampleProducts.map((product, index) => (
            ...
            >
              <Card className="group relative overflow-hidden bg-white rounded-3xl shadow-xl border-0 hover:shadow-2xl transition-all duration-500 transform-gpu hover:-translate-y-2 active:translate-y-0 min-h-[370px] md:min-h-[420px] lg:min-h-[420px] flex flex-col h-full justify-between">
                ...
                <CardContent className="relative p-0 z-10 flex flex-col h-full justify-between">
                  {/* Product Image */}
                  <div className="relative w-full h-44 md:h-56 lg:h-56 flex items-center justify-center bg-white rounded-t-3xl overflow-hidden min-h-[176px] md:min-h-[224px] lg:min-h-[224px]">
                    <div className="flex items-center justify-center w-full h-full overflow-hidden">
                      <Image
                        ...
                        width={120}
                        height={120}
                        className="object-contain mx-auto my-auto block"
                        style={{maxHeight: '120px', maxWidth: '120px'}}
                      />
                    </div>
                  </div>
                  {/* Product Info: only name and price */}
                  <div className="flex-1 flex flex-col items-center justify-center text-center w-full p-3 md:p-4">
                  ...
                  <div className="w-full flex items-end px-3 md:px-4 pb-3 md:pb-4">
