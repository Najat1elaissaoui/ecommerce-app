...
export default function ProductsGrid({ searchParams, viewMode = "grid" }: ProductsGridProps) {
  ...
  const mockProducts: Product[] = [
    ...
    },
    {
      ...
      price: 89.99,
      quantity: 100,
      description_ar: "فيتامين د3 عالي التركيز لصحة العظام والمناعة",
      images: ["/placeholder.svg?key=vitamin-d3"],
    ...
    },
    {
      ...
      price: 199.99,
      quantity: 75,
      description_ar: "زيت السمك الطبيعي لصحة القلب والدماغ",
      images: ["/placeholder.svg?key=omega-3"],
    ...
    },
    {
      ...
      price: 129.99,
      quantity: 60,
      description_ar: "مجموعة شاملة من الفيتامينات والمعادن للرجال",
      images: ["/placeholder.svg?key=multivitamin"],
    ...
    },
    {
      ...
      price: 179.99,
      quantity: 40,
      description_ar: "أحماض أمينية متفرعة السلسلة لتعافي العضلات",
      images: ["/placeholder.svg?key=bcaa"],
      low_stock_threshold: 10,
      is_active: true,
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString(),
