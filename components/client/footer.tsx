    ...
    <footer className="bg-black text-white border-t border-neutral-800 overflow-hidden">
      ...
      <div className="w-full">
        <svg
          ...
          className="w-full h-12 fill-black -mb-1"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-white mb-6 leading-relaxed">
              متجرك الموثوق للحصول على أفضل المكملات الغذائية عالية الجودة.
              نساعدك في تحقيق أهدافك الصحية واللياقية بأمان وفعالية.
            </p>
