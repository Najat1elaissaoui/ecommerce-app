...
const sampleProductData: ProductData = {
  ...
  detailedDescription:
    "علكة خل التفاح الأولى عالميًا. غنية بالفيتامينات والعناصر الغذائية لدعم الصحة العامة. استمتع بطعم التفاح بدون طعم الخل القوي!",
  productImage: "/goli1.png",
  benefits: {
    title: "فوائد صحية",
    items: [
      {
        name: "تعزيز الطاقة الخلوية",
        description:
          "علكة Goli ACV تحتوي على فيتامين B12 الذي يساعد في تحويل الطعام إلى طاقة.",
      },
      {
        name: "دعم المناعة الصحية",
        description: "تدعم جهاز المناعة بفضل مضادات الأكسدة الطبيعية.",
      },
      {
        name: "صحة القلب",
        description: "تساهم في تحسين صحة القلب والأوعية الدموية.",
      },
      {
        name: "تحسين التمثيل الغذائي",
        description: "تساعد في تنظيم عمليات الأيض وحرق الدهون.",
      },
      {
        name: "مضادات أكسدة إضافية",
        description:
          "تحتوي على مكونات غنية بمضادات الأكسدة لمحاربة الجذور الحرة.",
      },
      {
        name: "دعم الهضم",
        description: "خل التفاح معروف بفوائده في تحسين الهضم وصحة الأمعاء.",
      },
    ],
  },
  ingredients: [
    {
      ...
      image: "/ing2.png",
      description:
        "فيتامين B12 هو فيتامين قابل للذوبان في الماء يلعب دورًا في دعم صحة القلب، الطاقة الخلوية، الجهاز المناعي وتكوين خلايا الدم الحمراء.",
    },
    {
      name: "CoQ10 (مساعد الإنزيم Q10)",
      image: "/ing1.png",
      description:
        "مساعد الإنزيم Q10 هو مضاد أكسدة يوجد في العديد من خلايا الجسم ويساعد في محاربة الجذور الحرة. يلعب دورًا حيويًا داخل جزء الخلية المسؤول عن إنتاج الطاقة الخلوية - الميتوكوندريا.",
    },
    {
      name: "KSM-66® Ashwagandha",
      image: "/ing3.png",
      description:
        "KSM-66® Ashwagandha هو مستخلص عشبي معروف بخصائصه المهدئة والداعمة للصحة العامة. يساعد في تقليل التوتر وتعزيز الاسترخاء.",
    },
  ],
  video: {
  ...
  serving: {
    servingInfo: [
      ...
      {
        component: "فيتامين B12 (50% من الاحتياج اليومي)",
        quantity: "1.2 ميكروجم",
      },
    ],
  ...
  opinions: [
    {
      ...
      rating: 5,
      comment:
        "الطعم رائع والنتيجة مذهلة! أستخدمها منذ شهرين وأشعر بتحسن كبير.",
      date: "2024-01-15",
    },
    {
      customerName: "أحمد ك.",
...
const product2: ProductData = {
  ...
  benefits: {
    ...
    items: [
      ...
      {
        name: "صحة عامة أفضل",
        description: "تدعم الصحة العامة والشعور بالنشاط والحيوية.",
      },
    ],
  },
  ingredients: [
  ...
  return (
    <div className="min-h-screen bg-background pt-16">
      ...
      <main>
        ...
        {product.video && <ProductVideoSection video={product.video} />}
        ...
        {product.opinions && product.opinions.length > 0 && (
          <ProductOpinionsSection opinions={product.opinions} />
        )}
